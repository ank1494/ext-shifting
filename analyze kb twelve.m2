...
batchNum = 1;
folderName = "analysis klein bottle/twelve/";
...
elevensFile = concatenate(folderName, "thirteen to analyze.txt") << "";

triangulations = value get "kb triangs/twelve.m2";
...
finalEdge = {5,6}; --ADJUST THIS ACCORDING TO CASE!
