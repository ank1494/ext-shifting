...
batchNum = 1;
folderName = "analysis klein bottle/eight triangles/";
...
finalEdge = {1,5,6}; --ADJUST THIS ACCORDING TO CASE!
...
for i from 0 to 5 do (
	...
	--mcp = analyzeCritRegionsTriangle(triangulations_trIdx, finalEdge);
	logFile << "analyzing KB_" << toString i << endl;
	mcp = analyzeCritRegionsTriangle(KB_i, finalEdge);
